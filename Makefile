...
PHAN_IMAGE  := html-ast-phan:$(PHP_VERSION)
...
quality: rector cs phpstan phan ## Run all quality tools

ci: cs-check phpstan phan rector-check test-all ## Run the full CI pipeline locally
