...
| [WHATWG named-character-reference list](https://html.spec.whatwg.org/entities.json) | Public domain spec data | The full 2231-entry named-entity table, vendored verbatim as `resources/entities.json` and codegen'd into PHP by `bin/generate-entities.php`, plus the C1-control numeric-replacement table. | `Internal/Tokenizer/NamedCharacterReferences.php` (generated), `Internal/Tokenizer/Entities.php` |
